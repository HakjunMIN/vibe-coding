...
- [Step 03: 메시지 처리 및 응답 생성](../03-message-processing/README.md) 완료
- 웹 검색 기능을 위한 네트워크 연결
- 날씨 플러그인을 실행할 때 사용할 OpenWeatherMap API 키
...
- [이전: Step 03 메시지 처리 및 응답 생성](../03-message-processing/README.md)
