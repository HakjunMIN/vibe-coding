...
- [Step 02: 기본 Agent 구조 만들기](../02-basic-agent/README.md) 완료
- Azure OpenAI 설정이 담긴 `.env` 파일
...
- [이전: Step 02 기본 Agent 구조 만들기](../02-basic-agent/README.md)

메시지 처리와 응답 생성 기능이 완성되었습니다!

[Step 04: 커스텀 기능 추가](../04-custom-features/README.md)로 이동하여 플러그인과 고급 기능을 추가해봅시다.
